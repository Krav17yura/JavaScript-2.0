...
function a1(){
 ...
 function t1(){
     fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=1")
       .then(data => data.text())
       .then(data => {
...
/* Отправьте GET запрос (fetch) на сайт http://getpost.itgid.info/index2.php. В качестве action укажите 2. Добавьте параметр name с вашим именем на латинице. Если все сделано верно, сервер пришлет строку hello ваше имя. Выведите в out-2 результат. Запускаться функция должна по нажатию b-2. */
 ...
 function t2(){
     fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=2&name=Yura")
     .then(data  => data.text())
     .then(data => {
...
/*  Отправьте GET запрос (fetch) на сайт http://getpost.itgid.info/index2.php. В качестве action укажите 3. Добавьте параметр num1 и num2 содержащие числа. Если все сделано верно, сервер вернет сумму чисел.  Выведите в out-3 результат. Запускаться функция должна по нажатию b-3. */
  ...
  function t3(){
      fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=3&num1=2&num2=12")
      .then(data => data.text())
      .then(data => {
...
/*  Отправьте GET запрос (fetch) на сайт http://getpost.itgid.info/index2.php. В качестве action укажите 4. Добавьте параметр num1 и num2 содержащие числа. Если все сделано верно, сервер вернет случайное число в заданном диапазоне. Не забывайте указывать параметр auth (ключ в чате).  Выведите в out-4 результат. Запускаться функция должна по нажатию b-4. */
 ...
 function t4(){
     fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=4&num1=12&num2=3")
     .then(data => data.text())
     .then(data => {
...
function t5(){
    fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=5")
    .then(data => data.text())
    .then(data => {
...
function t6(){
    fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=6&num1=12&num2=22")
    .then(data => data.text())
    .then(data => {
...
function t7(){
    fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=7")
    .then(data => data.text())
    .then(data => {
...
/* Отправьте GET запрос (fetch) на сайт http://getpost.itgid.info/index2.php. В качестве action укажите 8. В качестве параметра по очереди укажите year равный году вашего рождения. Если все правильно сервер вернет ваш возраст. Не забывайте указывать параметр auth (ключ в чате). Выведите в out-8 результат. Запускаться функция должна по нажатию b-8.*/
 ...
 function t8(){
     fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=8&year=2000")
     .then(data => data.text())
     .then(data => {
...
function t9(){
    fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=9&m=1&d=1&y=1")
    .then(data => data.text())
    .then(data => {
...
function t11(){
    fetch('server.php',{
        ...
        body: "auth=zhrgB3DxC8LoG7Gcilzg&action=2&name=yura"
...
function t12(){
    fetch("server.php", {
      ...
      body: "auth=zhrgB3DxC8LoG7Gcilzg&action=3&num1=10&num2=12"
    })
    .then(response => response.text())
    .then(response => {
...
function t13(){
    fetch('server.php', {
        ...
        body: "auth=zhrgB3DxC8LoG7Gcilzg&action=4&num1=10&num2=20"
    })
    .then(response => response.text())
    .then(response => {
...
function t15(){
    fetch("server.php", {
        ...
        body: "auth=zhrgB3DxC8LoG7Gcilzg&action=6&num1=10&num2=12"
    })
    .then(response => response.text())
    .then(response => {
...
function t18(){
    fetch("server.php", {
        ...
        body: "auth=zhrgB3DxC8LoG7Gcilzg&action=9&m=1&d=1&y=1"
    })
    .then(response => response.text())
    .then(response => {
