...
document.querySelector(".div-3_1 ").ontouchstart = () => {
     document.querySelector(".out-3").textContent = 1;
};
document.querySelector(".div-3_2").ontouchstart = () => {
...
document.querySelector(".b-5").onclick = () => document.querySelector(".div-4").removeEventListener('touchstart', t4);


// Task 6 ============================================
/*  Добавьте событие ontouchend на div-4. При его срабатывании выведите в out-6 слово touchend. */
function t1(){
     document.querySelector(".out-6").textContent = "touch";
}
document.querySelector(".div-4").ontouchend = t1;
...
function t8(elem){
    ...
    let random = Math.floor(Math.random() * Math.floor(a8.length));
    console.log(random);
    elem.style.background = a8[random];
}
document.querySelector(".div-8").ontouchstart = function() {
     t8(this);
};
// Task 9 ============================================
...
document.querySelector(".div-9").ontouchstart = function(event){
      t9(event);
};
