...
let goods = new Goods("vodka", 0.5, "/1.jfif", 999);
console.log(goods);
goods.draw(document.querySelector(".t1"));
// Task 4.
// Создайте на основе класса Goods объект goods2, заполните свойства, примените метод draw для вывода товара на страницу в блок out-4.
 ...
 let goods2 = new Goods("PIVO", 1, '/1.jfif', 200);
...
let goods3 = new Goods2("vodka", 0.5, "/1.jfif", 999, ".out-4", true);
goods3.draw(document.querySelector(".out-5"));
...
// Создайте объект на основе класса Valid и задайте ему имя и пароль длиной 5 символов. Запустите метод validate() и выведите в консоль свойство isValid.
 let t8 = new Valid("Yura", "12345", false);
 t8.validate();
 console.log(t8.validate);
//Task 9.
...
let t9 = new Valid("Yura", "1234567", false);
t9.validate();
console.log(t9);
...
let t10 = new Valid2('', '12345678', false);
t10.validate();
console.log(t10);
...
let t11 = new Valid2('adasda', '12345678', false);
t11.validate();
console.log(t11);
