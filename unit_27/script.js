...
function t2(){
    let a = new Promise((resolve, reject) => {
       fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=3&num1=10&num2=20")
       .then(data =>resolve(data.text()));
    });

    let b = new Promise((resolve, reject) =>{
        fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=4&num1=10&num2=22")
        .then(data => resolve(data.text()));
    });
...
Выведите в out-3 результат. Запускаться функция должна по нажатию b-3. </p>
 ...
 function t3(){
     ...
     let b = new Promise((resolve,reject) => {
        fetch("server.php?auth=zhrgB3DxC8LoG7Gcilzg&action=6&num1=101&num2=22")
        .then(data => resolve(data.text()));
     });
...
function t6(){
    let a = new Promise((resolve, reject) => {
       fetch("server.php", {
           ...
           body: "auth=zhrgB3DxC8LoG7Gcilzg&action=3&num1=10&num2=22"
       })
       .then(data => resolve(data.text()));
    });
    ...
    let b = new Promise((resolve, reject) => {
          fetch("server.php", {
              ...
              body: "auth=zhrgB3DxC8LoG7Gcilzg&action=4&num1=10&num2=22"
          })
          .then(data => resolve(data.text()));
    });
...
function t7(){
    ...
    let b = new Promise((resolve,reject) => {
          fetch("server.php", {
            ...
            body: "auth=zhrgB3DxC8LoG7Gcilzg&action=6&num1=21&num2=33"
          })
          .then(data => resolve(data.text()));
    });
